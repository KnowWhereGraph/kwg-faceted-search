...
/* did I miss installing anything? Where to find the ../lib/oop and text_hightlight_rules? */
...
var TurtleHighlightRules = function() {
	...
	this.$rules = {
		...
		'#qnames': [{
			token: ['constant.language.prefix.turtle', 'keyword.operator.punctuation.turtle', 'entity.name.function.turtle'],
			// regex: /([a-zA-Z\u00c0-\u00d6\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c-\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd\u10000-\ueffff][\w\u00b7\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02ff\u0300-\u037d\u037f-\u1fff\u200c-\u200d\u203f-\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd\u10000-\ueffff.-]*)?(:)([_a-zA-Z](?:[-_a-zA-Z0-9.]*[-_a-zA-Z0-9]|))?/
			regex: /([a-zA-Z_](?:[\w.-]*[\w-])?)?(:)([\w_:-](?:[\w_:.-]*[\w_:-])?)?/,
		}],
		'#relative-urls': [{
...
(function() {
	...
	//     var worker = new WorkerClient(["ace"], require("brace/worker/turtle"), "TurtleWorker");
